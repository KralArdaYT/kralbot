...
if(!member) return message.reply(`**Kayıtsıza** Düşürülecek Kişiyi Etiketlemelisin !!`)


let üye = message.guild.members.cache.get(member.id)

üye.roles.add(kayıtsız)
üye.setNickname(`Kayıtsız Üye ✨`)
...
.setColor('BLUE')
.setAuthor('Kayıtsıza Düşürülen Kişinin Ve Yetkilinin Bilgileri; 📄')
.setDescription(`
...
name: "kayıt-kayıtsıza-düşür",
description: "Üyeleri Kayıtsıza Düşürürüm !!",
aliases: ['kayıtkayıtsızadüşür','kayıt-kayıtısızadüşür','kayıtkayıtsıza-düşür'],
kategori: "moderasyon",
usage: "",
}
