...
var StateList = function () {
    ...
    (0, _createClass3.default)(StateList, [{
        ...
        value: function init() {
            ...
            if (!sessionStorage.getItem("key")) {
                (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
                    var endpoint, queueUrl, firestoreConfig;
                        ...
                        while (1) {
                            switch (_context.prev = _context.next) {
                                case 0:
                                    ...
                                    if (_this.initial.queueUrl) {
                                        queueUrl = (0, _echo2.default)(_this.initial.queueUrl, _this.initial);
                                    }
                                    firestoreConfig = (0, _echo2.default)(_this.initial.firestoreConfig, _this.initial);
                                    _context.next = 7;
                                    return _this.record(endpoint, queueUrl, firestoreConfig, _this.initial, "initial");
        ...
        key: "push",
        value: function push(data, component, module_name) {
            var _extends2,
                _this2 = this;
            ...
            if (module_name != '') {
                this.state[this.index].module_name = module_name;
            }
                    ...
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                ...
                                if (_this2.initial.queueUrl) {
                                    queueUrl = (0, _echo2.default)(_this2.initial.queueUrl, _this2.initial);
                                }
                                firestoreConfig = (0, _echo2.default)(_this2.initial.firestoreConfig, _this2.initial);
                                _context2.next = 7;
                                return _this2.record(endpoint, queueUrl, firestoreConfig, _this2.state[_this2.index], _this2.index);
